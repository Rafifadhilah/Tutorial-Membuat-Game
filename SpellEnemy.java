import greenfoot.*;
public class SpellEnemy extends Spell
{
    public void act()
    {
    ...
    {
        for(TroopAlly ally : getObjectsInRange(radius, TroopAlly.class))
            ally.hp -= damage;
        for(TowerAlly tower : getObjectsInRange(radius, TowerAlly.class))
            tower.hp -= damage * 2 / 3;
    }
